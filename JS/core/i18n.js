...
const translations = {
  es: {
    ...
    cart_sync_precios: 'Actualizamos los precios de tu canasta con los del catálogo.',
    cart_sync_removidos: 'Quitamos de tu canasta productos que ya no están disponibles.',
  ...
  en: {
    ...
    cart_sync_precios: 'We updated your basket prices to match the catalog.',
    cart_sync_removidos: 'We removed items from your basket that are no longer available.',
